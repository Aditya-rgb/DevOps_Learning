...
while True:
    #putting it in a try block to check if there are any spaces in the passowrd!!
    try:

        password = input("Enter your password : ")
        if " " in password:
            raise ValueError("your password has spaces, rectify it...")
        else:
            print("Enter password again but this time without spaces : ")
        ...
        print(f"Error in your passwors is {v}")
